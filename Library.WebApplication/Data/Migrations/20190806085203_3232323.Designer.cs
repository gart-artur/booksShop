...
namespace Library.WebApplication.Data.Migrations
{
    ...
    [Migration("20190806085203_3232323")]
    partial class _3232323
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Library.DataAccess.FilterModels.AuthorFilterItem", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<int?>("AuthorFilterItemid");

                    b.HasKey("id");

                    b.HasIndex("AuthorFilterItemid");

                    b.ToTable("AuthorFilterItems");
                });
            ...
            modelBuilder.Entity("Library.DataAccess.FilterModels.AuthorFilterItem", b =>
                {
                    b.HasOne("Library.DataAccess.FilterModels.AuthorFilterItem")
                        .WithMany("Name")
                        .HasForeignKey("AuthorFilterItemid");
                });
